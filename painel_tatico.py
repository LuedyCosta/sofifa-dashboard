...
def renderizar_painel_tatico():
    ...
    st.markdown("Selecione uma formação para visualizar a disposição tática no campo e a análise detalhada de desempenho abaixo.")

    # Mapeamento e tradução amigável dos presets
    preset_traduzido = {
    ...
    # Matriz completa com as 28 formações
    matriz_dados = {
        "3142": {
            "preset": preset_traduzido["short-passing"],
            ...
            "pos": {"GOL": (50, 8), "Z1": (25, 20), "Z2": (50, 18), "Z3": (75, 20), "VOL": (50, 36), "AE": (12, 52), "MC1": (38, 52), "MC2": (62, 52), "AD": (88, 52), "ATA1": (38, 85), "ATA2": (62, 85)}
        },
        "3412": {
            "preset": preset_traduzido["heavy-metal"],
            ...
            "pos": {"GOL": (50, 8), "Z1": (25, 20), "Z2": (50, 18), "Z3": (75, 20), "ME": (12, 50), "MC1": (38, 45), "MC2": (62, 45), "MD": (88, 50), "MEI": (50, 68), "ATA1": (38, 86), "ATA2": (62, 86)}
        },
        "3421": {
            "preset": preset_traduzido["gegenpress"],
            ...
            "pos": {"GOL": (50, 8), "Z1": (25, 20), "Z2": (50, 18), "Z3": (75, 20), "ME": (12, 50), "MC1": (38, 45), "MC2": (62, 45), "MD": (88, 50), "SA1": (35, 72), "SA2": (65, 72), "ATA": (50, 88)}
        },
        "343": {
            "preset": preset_traduzido["wing-play"],
            ...
            "pos": {"GOL": (50, 8), "Z1": (25, 20), "Z2": (50, 18), "Z3": (75, 20), "ME": (12, 50), "MC1": (38, 48), "MC2": (62, 48), "MD": (88, 50), "PE": (20, 82), "ATA": (50, 88), "PD": (80, 82)}
        },
        "3511": {
            "preset": preset_traduzido["possession"],
            ...
            "pos": {"GOL": (50, 8), "Z1": (25, 20), "Z2": (50, 18), "Z3": (75, 20), "VOL": (50, 36), "ME": (12, 52), "MC1": (35, 52), "MC2": (65, 52), "MD": (88, 52), "SA": (50, 72), "ATA": (50, 88)}
        },
        "352": {
            "preset": preset_traduzido["balanced"],
            ...
            "pos": {"GOL": (50, 8), "Z1": (25, 20), "Z2": (50, 18), "Z3": (75, 20), "ALA L": (12, 50), "VOL1": (38, 38), "VOL2": (62, 38), "ALA R": (88, 50), "MEI": (50, 68), "ATA1": (38, 86), "ATA2": (62, 86)}
        },
        "41212-n (Losango Fechado)": {
            "preset": preset_traduzido["tikitaka"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL": (50, 38), "MC1": (35, 54), "MC2": (65, 54), "MEI": (50, 70), "ATA1": (38, 88), "ATA2": (62, 88)}
        },
        "41212-w (Losango Aberto)": {
            "preset": preset_traduzido["balanced"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL": (50, 38), "ME": (18, 56), "MD": (82, 56), "MEI": (50, 70), "ATA1": (38, 88), "ATA2": (62, 88)}
        },
        "4132": {
            "preset": preset_traduzido["vertical-counter"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL": (50, 38), "ME": (20, 62), "MC": (50, 60), "MD": (80, 62), "ATA1": (38, 86), "ATA2": (62, 86)}
        },
        "4141": {
            "preset": preset_traduzido["park-bus"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL": (50, 38), "ME": (18, 58), "MC1": (38, 58), "MC2": (62, 58), "MD": (82, 58), "ATA": (50, 86)}
        },
        "4213": {
            "preset": preset_traduzido["counter"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL1": (38, 42), "VOL2": (62, 42), "MEI": (50, 65), "PE": (20, 82), "ATA": (50, 88), "PD": (80, 82)}
        },
        "4222": {
            "preset": preset_traduzido["balanced"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL1": (38, 42), "VOL2": (62, 42), "MEI1": (30, 66), "MEI2": (70, 66), "ATA1": (38, 86), "ATA2": (62, 86)}
        },
        "4231-n (Fechado)": {
            "preset": preset_traduzido["possession"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL1": (38, 42), "VOL2": (62, 42), "MSE": (30, 68), "MEI": (50, 70), "MSD": (70, 68), "ATA": (50, 88)}
        },
        "4231-w (Aberto)": {
            "preset": preset_traduzido["gegenpress"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL1": (38, 42), "VOL2": (62, 42), "ME": (18, 68), "MEI": (50, 70), "MD": (82, 68), "ATA": (50, 88)}
        },
        "424": {
            "preset": preset_traduzido["gegenpress"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL1": (38, 48), "VOL2": (62, 48), "PE": (18, 84), "ATA1": (38, 86), "ATA2": (62, 86), "PD": (82, 84)}
        },
        "4312": {
            "preset": preset_traduzido["short-passing"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "MC1": (28, 48), "MC2": (50, 45), "MC3": (72, 48), "MEI": (50, 68), "ATA1": (38, 86), "ATA2": (62, 86)}
        },
        "4321": {
            "preset": preset_traduzido["heavy-metal"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "MC1": (28, 48), "MC2": (50, 45), "MC3": (72, 48), "SA1": (36, 72), "SA2": (64, 72), "ATA": (50, 88)}
        },
        "433-flat (Tradicional)": {
            "preset": preset_traduzido["balanced"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "MC1": (30, 50), "MC2": (50, 50), "MC3": (70, 50), "PE": (20, 80), "ATA": (50, 88), "PD": (80, 80)}
        },
        "433-holding (Defensivo)": {
            "preset": preset_traduzido["possession"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL": (50, 40), "MC1": (32, 54), "MC2": (68, 54), "PE": (20, 80), "ATA": (50, 88), "PD": (80, 80)}
        },
        "433-defend (Contenção)": {
            "preset": preset_traduzido["park-bus"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL1": (35, 40), "VOL2": (65, 40), "MC": (50, 56), "PE": (20, 80), "ATA": (50, 88), "PD": (80, 80)}
        },
        "433-attack (Ofensivo)": {
            "preset": preset_traduzido["gegenpress"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL1": (35, 44), "VOL2": (65, 44), "MEI": (50, 68), "PE": (20, 80), "ATA": (50, 88), "PD": (80, 80)}
        },
        "433-false9 (Falso 9)": {
            "preset": preset_traduzido["tikitaka"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "VOL": (50, 40), "MC1": (32, 54), "MC2": (68, 54), "PE": (20, 82), "F9": (50, 72), "PD": (80, 82)}
        },
        "4411": {
            "preset": preset_traduzido["counter"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "ME": (18, 55), "MC1": (38, 52), "MC2": (62, 52), "MD": (82, 55), "SA": (50, 72), "ATA": (50, 88)}
        },
        "442-flat (Clássico)": {
            "preset": preset_traduzido["vertical-counter"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "ME": (18, 55), "MC1": (38, 52), "MC2": (62, 52), "MD": (82, 55), "ATA1": (38, 85), "ATA2": (62, 85)}
        },
        "442-holding (Protegido)": {
            "preset": preset_traduzido["balanced"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "ME": (18, 55), "VOL1": (38, 42), "VOL2": (62, 42), "MD": (82, 55), "ATA1": (38, 85), "ATA2": (62, 85)}
        },
        "451": {
            "preset": preset_traduzido["possession"],
            ...
            "pos": {"GOL": (50, 8), "LE": (15, 25), "Z1": (38, 22), "Z2": (62, 22), "LD": (85, 25), "ME": (15, 58), "MC1": (32, 52), "MC2": (50, 55), "MC3": (68, 52), "MD": (85, 58), "ATA": (50, 86)}
        },
        "5122": {
            "preset": preset_traduzido["counter"],
            ...
            "pos": {"GOL": (50, 8), "AE": (12, 32), "Z1": (30, 22), "Z2": (50, 20), "Z3": (70, 22), "AD": (88, 32), "VOL": (50, 42), "MC1": (35, 58), "MC2": (65, 58), "ATA1": (38, 86), "ATA2": (62, 86)}
        },
        "5212": {
            "preset": preset_traduzido["vertical-counter"],
            ...
            "pos": {"GOL": (50, 8), "AE": (12, 32), "Z1": (30, 22), "Z2": (50, 20), "Z3": (70, 22), "AD": (88, 32), "VOL1": (38, 42), "VOL2": (62, 42), "MEI": (50, 66), "ATA1": (38, 86), "ATA2": (62, 86)}
        },
        "5221": {
            "preset": preset_traduzido["wing-play"],
            ...
            "pos": {"GOL": (50, 8), "AE": (12, 32), "Z1": (30, 22), "Z2": (50, 20), "Z3": (70, 22), "AD": (88, 32), "VOL1": (38, 45), "VOL2": (62, 45), "SA1": (32, 70), "SA2": (68, 70), "ATA": (50, 88)}
        },
        "523": {
            "preset": preset_traduzido["counter"],
            ...
            "pos": {"GOL": (50, 8), "AE": (12, 32), "Z1": (30, 22), "Z2": (50, 20), "Z3": (70, 22), "AD": (88, 32), "VOL1": (38, 45), "VOL2": (62, 45), "PE": (20, 82), "ATA": (50, 88), "PD": (80, 82)}
        },
        "532": {
            "preset": preset_traduzido["park-bus"],
            ...
            "pos": {"GOL": (50, 8), "AE": (12, 32), "Z1": (30, 22), "Z2": (50, 20), "Z3": (70, 22), "AD": (88, 32), "MC1": (30, 52), "MC2": (50, 50), "MC3": (70, 52), "ATA1": (38, 85), "ATA2": (62, 85)}
        },
        "541": {
            "preset": preset_traduzido["park-bus"],
            ...
            "pos": {"GOL": (50, 8), "AE": (12, 32), "Z1": (30, 22), "Z2": (50, 20), "Z3": (70, 22), "AD": (88, 32), "ME": (18, 55), "MC1": (38, 52), "MC2": (62, 52), "MD": (82, 55), "ATA": (50, 86)}
        }
    }

    # Seletor com todas as formações
    formacao_selecionada = st.selectbox(
        "Escolha a Formação Tática:",
        list(matriz_dados.keys()),
        index=0
    )

    dados = matriz_dados[formacao_selecionada]
